...
export class RoleService {
  ...
  deleteRole(role: Role) {
    ...
    this.api
      .delete(EndpointRole.DELETE_ROLE + role._id, {
        Authorization: 'Bearer ' + this.api.getAccessToken(),
        body: role,
      })
      .subscribe(
  ...
  addRoleOnUser(requestBody: { userId: string; roleId: string }) {
    ...
    this.api
      .post(EndpointRole.ADD_ROLE_ON_USER, requestBody, this.authorisation)
      .subscribe(
        (resp) => {
          this.waitingResponse = false;
          this.roleAdded = true;
  ...
  removeRole(requestBody: { roleId: string; userId: string }) {
    ...
    this.api
      .delete(EndpointRole.REMOVE_ROLE, this.authorisation, requestBody)
      .subscribe(
        (resp) => {
